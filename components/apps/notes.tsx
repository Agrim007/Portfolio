...
## Summary
Computer Science graduate with a strong foundation in backend development, APIs, and quality engineering. Experienced in Python, Java, and C++, with hands-on exposure to FastAPI, automation testing, databases, and cloud basics. Known for analytical thinking, adaptability, and collaborative problem-solving.

Currently focused on building scalable backend systems, data-driven applications, and intelligent AI-powered solutions.`,
      date: "Today",
    },
    {
      id: 2,
...
**Tech:** Python, Scikit-Learn, Power BI, Machine Learning  
- Built ML workflows to analyze consumer financial behavior.
- Designed automated Power BI dashboards for cohort and funnel analysis.
- Improved user engagement by 15–20% and reduced churn by 10%.

## Diet Planner Web App
**Tech:** Python, FastAPI, JavaScript, API Testing  
- Developed and validated APIs for personalized diet planning.
- Automated regression testing for backend stability.
- Integrated real-time analytics for scalability and performance insights.

## Intelligent Chatbot (Google Gemini API)
**Tech:** Python, FastAPI, NLP  
- Built a context-aware chatbot with adaptive responses.
- Designed a modular architecture for scalable NLP expansion.
- Improved conversational depth and user engagement.`,
      date: "2 days ago",
    },
    {
      id: 4,
...
**Kurukshetra University** (2021 – 2025)  
- GPA: 7.91  
- Coursework: OOPS, DBMS, Computer Networks, OS, Software Testing
...
CBSE – 85.83% (2018)`,
    ...
    },
    {
      ...
      content: `# Activities & Achievements

🏅 **Table Tennis Gold Medalist (2022–2023)**  
- Demonstrated discipline, adaptability, and teamwork at the state level.

🎯 **Event & Sponsorship Lead – GDSC**
- Organized technical workshops and troubleshooting sessions.
- Coordinated cross-functional teams for events.

📢 **Marketing Lead – IIC / E-CELL**
- Led campus-wide promotions for innovation and entrepreneurship initiatives.`,
      date: "Last week",
    },
  ])
